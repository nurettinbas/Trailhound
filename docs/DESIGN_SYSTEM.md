...
| `GlassStyle.swift` | Atmosphere, surfaces, chips, list chrome, `.glassNestedChoice(isSelected:)` (frost fill inside a card — not a second Material), `.glassCircleChrome()` (44pt overlay collapse) |
