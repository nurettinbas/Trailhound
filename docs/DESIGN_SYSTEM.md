...
| File | Role |
|---|---|
| `ShellPalette.swift` / `GlassContrast.swift` | 20 hues, Light/Dark triplets, mid-family glass tint (not chrome plates). `ShellRGB.complementaryInk` is the opposite vivid hue (forecast sparkline). |
