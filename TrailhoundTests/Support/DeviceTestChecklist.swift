...
enum DeviceTestChecklist {
    static let items = [
        ...
        "CarPlay Live Activity tile: after 1+ hour / long km, Duration Distance Speed stay the same size, centered in their columns, no overlap; car icon size unchanged; cancel a CarPlay phone call — labels/values are not stacked on top of older frames; chrome matches Maps / Now Playing (same native glass, map shows through — not extra frost)",
